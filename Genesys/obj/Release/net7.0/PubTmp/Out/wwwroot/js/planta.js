...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({ //capturamos el id de nuestra tabla de la vista razor por medio de jquery
        ...
        "columns": [ // en la seccion columnas se renderizan las columnas o propiedades de la tabla
            ...
            { "data": "nombrePlanta" },
            {
                "data": "statusPlanta", //como estado es booleana creamos una funcion para imprimir activo (true) o inactivo(false)
            ...
            {
                "data": "idPlanta", //la columna vacia tiene que ver con los botones, le pasamos el id de data mediante un render
...
function Delete(url) {
    swal({
        title: "¿Está seguro de eliminar la planta?",
